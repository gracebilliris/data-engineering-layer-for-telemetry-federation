# Telemetry Ingestion & Normalisation Demo
...
## Purpose
This demo illustrates the feasibility of a **Data Federation Layer**, showing that heterogeneous telemetry can be processed, normalised, and monitored in a traceable, reliable workflow.
